"""
Django settings for gestao_terreiro project.
...
CSRF_TRUSTED_ORIGINS= ["https://terreiro-admin-production.up.railway.app"]
...
SECRET_KEY = 'django-insecure-i)=@grseag_0$a%tcr_6!r3ni1#w%bh6v!233uxhdx)&3)ucv_'
...
ROOT_URLCONF = 'gestao_terreiro.urls'
...
WSGI_APPLICATION = 'gestao_terreiro.wsgi.application'
